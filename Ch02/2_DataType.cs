...
namespace Ch02
{
    internal class _2_DataType
    {
        static void Main1(string[] args)
        {
            ...
            byte  num2 = 255;          // 2byte, 부호 없는 정수, 0 ~ 255
            short num3 = 32767;        // 3byte, 부호 없는 정수, -32,788 ~ 32,767
            int   num4 = 2147483647;   // 4byte, 부호 없는 정수, -12,147,483,648 ~ 2,147,483,647
            long  num5 = 2147483648L;  // 5byte, 부호 없는 정수, 교재참조
