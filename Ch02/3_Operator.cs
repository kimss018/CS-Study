...
namespace Ch02
{
    internal class _3_Operator
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"rds1 : {res1}");
            Console.WriteLine($"rds2 : {res2}");
            Console.WriteLine($"rds3 : {res3}");
            Console.WriteLine($"rds4 : {res4}");
            Console.WriteLine($"rds5 : {res5}");
